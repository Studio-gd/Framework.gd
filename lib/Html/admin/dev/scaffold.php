...
$data.= '<div class="fieldGroup">'.

'<div class="inputGroup">'.
IB_Form_Input::create('labels[]')->placeholder('Label')->value('Title')->get().
IB_Form_Input::create('fields[]')->placeholder('Field')->value('title')->get().
IB_Form_Input::create('types[]')-> placeholder('Type')->value('varchar(200)')->get().
...
'<div class="inputGroup">'.
IB_Form_Input::create('labels[]')->placeholder('Label')->value('user_id')->get().
IB_Form_Input::create('fields[]')->placeholder('Field')->value('user_id')->get().
IB_Form_Input::create('types[]')-> placeholder('Type')->value('int(6) unsigned')->get().
IB_Form_Input::create('selectRessources[]')-> placeholder('Select Ressource')->get().
'</div>'.
