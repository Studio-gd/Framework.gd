...
echo '<script>TITLE="'.TITLE.TITLE_SEPARATOR.'";HOME="'.HOMEPAGE.'";LOGGEDIN='.intval(reader()).'</script>';
...
?><!--[if lt IE 9]><script src="/js/lib/html5.js"></script><script src="//ajax.googleapis.com/ajax/libs/chrome-frame/1/CFInstall.min.js"></script><![endif]--></head>